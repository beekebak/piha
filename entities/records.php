...
<body>
    ...
    <?php
        ...
        echo "<table border='1'>";
        while ($row = $res->fetch()) {
            echo "<tr><td><a href=\"../instances/elective.php?elective_id=${row['elective_id']}\">${row['elective_name']}</a></td>
                  <td><a href=\"../instances/student.php?student_id=${row['student_id']}\">${row['student_name']}</a></td></tr>";
        }
        echo "</table>";
    ?>
</body>
